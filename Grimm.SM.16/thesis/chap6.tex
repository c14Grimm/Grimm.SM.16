...
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTradPurspurscolorplot2}
...
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTradPurspurscolorplot3}
	\caption{4 Iteration }
	\label{100IR4DTPCP3}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTradPurspurscolorplot5}
...
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTradPurspurscolorplot7}
...
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTradEvadevadcolorplot2}
	\caption{3 Iterations}
	\label{100IR4DTECP2}
\end{subfigure}
\vskip\baselineskip
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTradEvadevadcolorplot3}
	\caption{4 Iteration }
	\label{100IR4DTECP3}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTradEvadevadcolorplot5}
	\caption{6 Iterations}
	\label{100IR4DTECP5}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTradEvadevadcolorplot7}
	\caption{8 Iterations}
	\label{100IR4DTECP7}
\end{subfigure}
\vskip\baselineskip
...
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTVIPurspurscolorplot2}
	\caption{3 Iterations}
	\label{100IR4DTVIPCP2}
\end{subfigure}
\vskip\baselineskip
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTVIPurspurscolorplot3}
	\caption{4 Iteration }
	\label{100IR4DTVIPCP3}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTVIPurspurscolorplot5}
	\caption{6 Iterations}
	\label{100IR4DTVIPCP5}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTVIPurspurscolorplot7}
	\caption{8 Iterations}
	\label{100IR4DTVIPCP7}
\end{subfigure}
\vskip\baselineskip
\begin{subfigure}[b]{0.3\textwidth}
	\centering
...
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTVIEvadevadcolorplot2}
	\caption{3 Iterations}
	\label{100IR4DTVIECP2}
\end{subfigure}
\vskip\baselineskip
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTVIEvadevadcolorplot3}
	\caption{4 Iteration }
	\label{100IR4DTVIECP3}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTVIEvadevadcolorplot5}
	\caption{6 Iterations}
	\label{100IR4DTVIECP5}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR4DTVIEvadevadcolorplot7}
	\caption{8 Iterations}
	\label{100IR4DTVIECP7}
\end{subfigure}
\vskip\baselineskip
\begin{subfigure}[b]{0.3\textwidth}
	\centering
...
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR6DTVIPurspurscolorplot2}
	\caption{3 Iterations}
	\label{100IR6DTVIPCP2}
\end{subfigure}
\vskip\baselineskip
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR6DTVIPurspurscolorplot3}
	\caption{4 Iteration }
	\label{100IR6DTVIPCP3}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR6DTVIPurspurscolorplot5}
	\caption{6 Iterations}
	\label{100IR6DTVIPCP5}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR6DTVIPurspurscolorplot7}
	\caption{8 Iterations}
	\label{100IR6DTVIPCP7}
\end{subfigure}
\vskip\baselineskip
\begin{subfigure}[b]{0.3\textwidth}
	\centering
...
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR6DTVIEvadevadcolorplot2}
	\caption{3 Iterations}
	\label{100IR6DTVIECP2}
\end{subfigure}
\vskip\baselineskip
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR6DTVIEvadevadcolorplot3}
	\caption{4 Iteration }
	\label{100IR6DTVIECP3}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR6DTVIEvadevadcolorplot5}
	\caption{6 Iterations}
	\label{100IR6DTVIECP5}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR6DTVIEvadevadcolorplot7}
	\caption{8 Iterations}
	\label{100IR6DTVIECP7}
\end{subfigure}
\vskip\baselineskip
\begin{subfigure}[b]{0.3\textwidth}
	\centering
...
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR6DTVIEvadthetacolorplot2}
	\caption{3 Iterations}
	\label{100IR6DTVITCP2}
\end{subfigure}
\vskip\baselineskip
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR6DTVIEvadthetacolorplot3}
	\caption{4 Iteration }
	\label{100IR6DTVITCP3}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR6DTVIEvadthetacolorplot5}
	\caption{6 Iterations}
	\label{100IR6DTVITCP5}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.3\textwidth}
	\centering
	\includegraphics[width=\textwidth]{100IR6DTVIEvadthetacolorplot7}
	\caption{8 Iterations}
	\label{100IR6DTVITCP7}
\end{subfigure}
\vskip\baselineskip
\begin{subfigure}[b]{0.3\textwidth}
	\centering
